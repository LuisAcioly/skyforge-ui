    ...
    return (
      <TooltipPrimitive.Portal>
        <TooltipPrimitive.Content
          ...
          className={cn(
            "sf-popover-content z-sf-tooltip max-w-[calc(100vw-2rem)] break-words rounded-sf-lg border border-border-strong bg-surface-inverse px-sf-12 py-sf-8 font-body text-caption text-content-inverse shadow-sf-2 outline-none sm:max-w-[260px]",
            className
          )}
          {...props}
        >
